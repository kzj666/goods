(function () {
    function wa(d) {
        ...
        l.zid || l.isTouch || l.dj || (U("__xsptplusUT_" + N, 1, new Date(E), "/", ba), l.isTouch = 1, l.dj = 1, b({
            url: I("//cms.gtags.net/g?z=__zpCMSDCB") + "&a=" + d.a,
            callback: function () {
                l.isGet = 1;
                l.ds = 1;
                g()
    ...
    var q = document, m = window, qa = navigator, V = Image, O = Array, f = encodeURIComponent, b = decodeURIComponent,
        da = "", J = "", N = "", ra, ea = 0, ba, T = function (d) {
            ...
            if (void 0 == b.zpclkid || "" == b.zpclkid) b.zpclkid = window.__zpclkid;
            return b
        }, fa = function (d, b, g) {
        ...
        P = [["m.baidu", "word"], ["wap.baidu", "word"], ["opendata.baidu", "wd"], ["baidu", "word"], ["baidu", "wd"], ["baidu", "q1"], ["baidu", "kw"], ["google", "q"], ["soso", "w"], ["sogou", "query"], ["youdao", "q"], ["bing", "q"], ["yahoo", "p"], ["so.360.cn", "q"], ["360so", "q"], ["360sou", "q"], ["so.com", "q"], ["ask", "q"], ["3721", "name"], ["vent", "kw"], ["ucweb", "keyword"], ["ucweb", "word"], ["114so", "kw"], ["haosou", "q"], ["chinaso", "q"], ["zhongsou", "w"], ["etao.com", "q"], [".sm.cn", "q"]],
        ha = function (b) {
            var f = /^https?:\/\/(.*?)($|\/.*)/.exec(b);
            if (null != f) {
                var g = "", g = f[1];
                b = W(b);
                for (f = 0; f < P.length; f++) if (0 <= g.indexOf(P[f][0]) && "undefined" != typeof b[P[f][1]]) return [2, n(g), "", "", n(b[P[f][1]]), ""];
                return [3, n(g), "", "", "", ""]
            }
            return [3, n(b), "", "", "", ""]
        };
    (new function () {
        function d(b, c) {
            ...
            setTimeout(function () {
                try {
                    document.body && document.body.insertBefore(d, document.body.firstChild)
                } catch (a) {
        ...
        var Q = "", k = "", R = "", ia = "", e = "", ja = "", Z = {}, sa = {
            ...
            "" != K && (a = a + "&rid=" + f(K));
            "" != Q && (a = a + "&uid=" + f(Q));
            if (2 == b) c = "imp/dasp", "" != k && (a = a + "&pi=" + k), "" != R && (a = a + "&pt=" + R), "" != e && (a = a + "&args=" + e); else if (3 == b) {
                c = "imp/dasp3";
                ...
                if ("object" == typeof b) for (d in b) if (b.hasOwnProperty(d)) {
                    ...
                    if ("p_zp_type" == g) {
                        ...
                        if ("string" == typeof p || "number" == typeof p) na = f(G(p))
            ...
            var a = [], a = W(w);
            return "undefined" != typeof a.zpclkid || "undefined" != typeof a.utm_source && "undefined" != typeof a.utm_campaign && "undefined" != typeof a.utm_medium ? ("undefined" != typeof a.zpclkid ? (F = r = "zampda", t = n(a.zpclkid), A = ha(B)[4], H = "") : (r = n(a.utm_source), F = n(a.utm_medium), t = n(a.utm_campaign), A = "undefined" != typeof a.utm_term ? n(a.utm_term) : ha(B)[4], H = "undefined" != typeof a.utm_content ? n(a.utm_content) : ""), h = 1, [!0, [h, r, F, t, A, H].join("|")]) : "" == B || null == B || "undefined" == B || (new RegExp("^https?://[\\w\\.]*?" + Y + "($|/.*|:.*)")).test(B) ? b && 0 == c.length ? (h = 4, r = F = t = A = H = "", [!0, [h, "||||"].join("|")]) : [!1, c.join("|")] : (a = ha(B), 2 == a[0] || 3 == a[0] && b ? (h = a[0], r = a[1], A = a[4], F = t = H = "", [!0, a.join("|")]) : [!1, c.join("|")])
        }, va = function (b) {
            b = W(w);
        ...
        this.pageView = function () {
            ...
            0 < arguments.length ? (B = w, w = arguments[0], w = w.replace(/\t|\n|\r/g, "")) : (w = xa(), B = ga());
            wa({
                fun: function (c) {
                    J = c;
                    c = new Date;
                    ...
                    if (!t || 5 > t.length) n = !0; else {
                        ...
                        if (5 != z.length || 6 != A.length) n = !0; else {
                            ...
                            1800 <= r - h && (n = !0);
                            C != (new Date(parseInt(r + "000"))).getDate() && (n = !0)
                        }
                    }
                    t = [!0, ""];
                    ...
                    fa();
                    "" != ma && (a = "a=" + v + "&c=" + ma + "&zid=" + J + "&allow=0&type=23", "" != K && (a = a + "&i=" + f(K)), "" != na && (a = a + "&info=" + na), "" != w && (a = a + "&u=" + f(w)), "" != B && (a = a + "&ru=" + f(B)), a += "&r=" + Math.random(), c = I("//ut.gtags.net/imp/conv") + "?" + a, 2084 < c.length && ca() && (a = a.replace("&u=" + f(w), ""), c = (I("//ut.gtags.net/imp/conv") + "?argserror=true&" + a).substring(0, 2084)), a = new V, m.__zp_smartpixel_list["//ut.gtags.net/imp/conv_" + v] = a, a.src = c);
                    if ("" != ja && !pa(Z)) {
                        c = "a=" + v + "&t=" + ja;
                        for (var D in Z) c += "&" + D + "=" + f(G(Z[D]));
                        c += "&_=" + (Math.random() + "").substr(2);
                        D = I("//ut.gtags.net/imp/material") + "?" + c;
    ...
    window.__zampBroadcast || (window.__zampBroadcast = function () {
        try {
            var b = function (g, f) {
                ...
                d = d || "opener.top";
                if (b == opener) g = d; else
                    for (var h = 0, l; h < b.frames.length && (l = b.frames[h]); h++) f(l, d + ".frames[" + h + "]")
            }, g = "", m = opener.top, n = [], l = {};
            f(m);
            (function (b, d) {
    ...
    (function () {
        function b() {
            m || (m = 1, clearInterval(g), g = setInterval(function () {
                null != J && null != N && (clearInterval(g), (new Image).src = I("//dat.gtags.net/imp/hm") + "?zid=" + J + "&a=" + N + "&u=" + encodeURIComponent(document.location) + "&ru=" + encodeURIComponent(ga()) + "&_=" + Math.random())
            }, 50))
        }
        ...
        function f(g) {
            function l(f) {
                ...
                document.all ? (x = f.clientX, y = f.clientY) : (x = f.pageX, y = f.pageY);
...
(function () {
    window.onload = function () {
        if (window.location.host == 'www.clarins.com.cn') {
            ...
            function parseParam(url) {
                ...
                for (i = 0; i < len; i++) {
                    ...
                    if (json[key]) {
                        json[key] = Object.prototype.toString.call(json[key]) === '[object Array]' ? json[key] : [json[key]];
                        json[key].push(val);
                    } else {
                        json[key] = val;
                    }
            ...
            function show(event) {
                var screenh = document.documentElement.scrollHeight > document.documentElement.clientHeight ? document.documentElement.scrollHeight : document.documentElement.clientHeight;
                var screenw = document.documentElement.scrollWidth > document.documentElement.clientWidth ? document.documentElement.scrollWidth : document.documentElement.clientWidth;
                var padLeft = (document.body.clientWidth - 1250) / 2;
                event = window.event || event;
                var x = event.pageX || event.clientX + (document.documentElement.scrollLeft || document.body.scrollLeft);
                x = x - padLeft;
                var y = event.pageY || event.clientY + (document.documentElement.scrollTop || document.body.scrollTop);
                var rate = screenw / screenh
                var Yrate = y / screenh
                ...
                image1.src = 'https://ut.gtags.net/imp/xy?zid=' + zid + '&timestamp=' + timestamp + '&page=' + page + '&refer=' + refer + '&screenw=' + screenw + '&advertiser_id=' + 587 + '&screeny=' + screenh + '&x=' + x + '&y=' + y + '&rate=' + rate
                    + '&Yrate=' + Yrate
            }
            ...
            image2.src = 'https://ut.gtags.net/imp/xy?zid=' + zid + '&timestamp=' + timestamp + '&page=' + page + '&refer=' + refer + '&screenw=' + screenw + '&advertiser_id=' + 587 + '&screeny=' + screenh;
        }
    }
})();